...
declare module TypeScript {
    class PullTypeCheckContext {
        ...
        private currentImplementsClauseTypeCheckClassPublicProperties;
        constructor(compiler: TypeScriptCompiler, script: Script, scriptName: string);
        public getCurrentImplementsClauseTypeCheckClassPublicProperties(): PullSymbol[];
        public setCurrentImplementsClauseTypeCheckClassPublicProperties(props: PullSymbol[]): void;
...
declare module Services {
    ...
    function forwardCall(logger: TypeScript.ILogger, actionDescription: string, action: () => any, throwOnError?: boolean): any;
    ...
    class LanguageServiceShim extends ShimBase implements ILanguageServiceShim {
        ...
        public forwardCall(actionDescription: string, action: () => any, throwOnError?: boolean): any;
