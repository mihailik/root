...
module pe.managed.metadata {
	...
	//All of the methods gathered together as an TableKind.Event shall be defined on the class (ECMA-335 §I.8.11.4)
	...
	export class Event {
		...
		//more precisely, a TableKind.TypeDefOrRef (ECMA-335 §24.2.6) coded index.
