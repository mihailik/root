        ...
        (function (metadata) {
            var TableStreamReader = (function () {
                function TableStreamReader(baseReader, streams, tables) {
                    ...
                    this.readHasFieldMarshal = this.createCodedIndexReader(metadata.TableKind.Field, metadata.TableKind.ParameterDefinition);
...
(function (pe) {
    (function (managed) {
        (function (metadata) {
            var Field = (function () {
                function Field() { }
                Field.prototype.internalReadRow = function (reader) {
