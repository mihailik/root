...
(function (test_PEFile_read_sample64Exe) {
    ...
    test_PEFile_read_sample64Exe.read_peHeader_machine_I386 = read_peHeader_machine_I386;
    function read_optionalHeader_peMagic_NT32() {
        var bi = new pe.io.BufferBinaryReader(sampleBuf);
        var pef = new pe.headers.PEFile();
        pef.read(bi);
    ...
    test_PEFile_read_sample64Exe.read_optionalHeader_peMagic_NT32 = read_optionalHeader_peMagic_NT32;
    function read_optionalHeader_numberOfRvaAndSizes_16() {
        var bi = new pe.io.BufferBinaryReader(sampleBuf);
        var pef = new pe.headers.PEFile();
        pef.read(bi);
    ...
    test_PEFile_read_sample64Exe.read_optionalHeader_dataDirectories_14_address_8200 = read_optionalHeader_dataDirectories_14_address_8200;
    function read_optionalHeader_dataDirectories_14_size_72() {
        var bi = new pe.io.BufferBinaryReader(sampleBuf);
        var pef = new pe.headers.PEFile();
        pef.read(bi);
    ...
    test_PEFile_read_sample64Exe.read_sectionHeaders_length_3 = read_sectionHeaders_length_3;
    function read_sectionHeaders_names_DOTtext_DOTrsrc_DOTreloc() {
        var bi = new pe.io.BufferBinaryReader(sampleBuf);
        var pef = new pe.headers.PEFile();
        pef.read(bi);
    ...
    test_PEFile_read_sample64Exe.read_sectionHeaders_names_DOTtext_DOTrsrc_DOTreloc = read_sectionHeaders_names_DOTtext_DOTrsrc_DOTreloc;
